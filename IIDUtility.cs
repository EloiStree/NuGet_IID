...
public  class IIDUtility
{
    ...
    public static (int, int) BytesToIndexInteger(byte[] bytes)
    {
    ...
    public static (int, long) BytesToIndexDate(byte[] bytes)
    {
        int index = BitConverter.ToInt32(bytes, 0);
        long date = BitConverter.ToInt64(bytes, 4);
        return (index, date);
    }

    public static (int, int, long) BytesToIndexIntegerDate(byte[] bytes)
    {
        int index = BitConverter.ToInt32(bytes, 0);
        int value = BitConverter.ToInt32(bytes, 4);
        long date = BitConverter.ToInt64(bytes, 8);
